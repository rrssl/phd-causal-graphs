...
def main():
    ...
    pulley_ball = prim.Ball(name="ball", radius=.005, mass=.02)
    ...
    pulley_cube_path.set_pos(Point3(0, .28, .25))
    rope_pulley = prim.RopePulley(
        name="rope-pulley",
        comp1_pos=Point3(0, 0, .005), comp2_pos=Point3(0, 0, .01),
        rope_length=.2, pulleys=[[0, .17, .25], [0, .25, .3]],
        pulley_extents=(.002, .004)
    )
    rope_pulley.create(
        geom='LD', phys=True, parent=app.models, world=app.world,
