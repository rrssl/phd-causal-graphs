...
t = .007
MASS = .00305
#  FLOOR_MATERIAL_FRICTION = 0.5
#  DOMINO_MATERIAL_FRICTION = 0.5
#  DOMINO_MATERIAL_RESTITUTION = 0.
#  DOMINO_ANGULAR_DAMPING = 0.
FLOOR_MATERIAL_FRICTION = 0.8677373
DOMINO_MATERIAL_FRICTION = 0.4632506
DOMINO_MATERIAL_RESTITUTION = 0.54047324
DOMINO_ANGULAR_DAMPING = 0.01627108
# Computed values
